...
public class ConsumerTwo {
	 ...
	 private static final Logger LOGGER = LogManager.getLogger(ConsumerTwo.class);
	...
	public static void main(String[] a) {
			...
			properties.put(ConsumerConfig.CLIENT_ID_CONFIG, "consumer_two");		
			...
			while(true) {
				...
				for (ConsumerRecord<String, String> consumerRecord : poll) {
					LOGGER.info("ConsumerTwo:{} at offset:{} from partition:{}",consumerRecord.value(),
