...
public class ConsumerThree {
	 ...
	 private static final Logger LOGGER = LogManager.getLogger(ConsumerThree.class);
	...
	public static void main(String[] a) {
			...
			properties.put(ConsumerConfig.CLIENT_ID_CONFIG, "consumer_three");		
			...
			while(true) {
				...
				for (ConsumerRecord<String, String> consumerRecord : poll) {
					LOGGER.info("Consumerthree:{} at offset:{} from partition:{}",consumerRecord.value(),
